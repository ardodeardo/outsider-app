  ...
  return (
    <div className='relative w-full mt-10'>
      <form action={`/search`} method="get">
        <input type="text" name="q" className='w-full p-3 pr-10 dark:bg-black border border-grey dark:border-blue-primary rounded-lg text-base' placeholder='Search news..' value={keyword} maxLength={100} onChange={(e) => handleSearch(e)} />
